  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50">
      ...
      <main className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 text-purple-700 rounded-full text-sm font-semibold">
              ...
              Build the Future of Campus Research
            </span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            <br />
            Your contributions make a difference in academic advancement.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <Link href="/upload?university=xidian" className="group">
            <div className="relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border-2 border-transparent hover:border-purple-400 overflow-hidden transform hover:-translate-y-2">
              ...
              <div className="relative text-center">
                {/* Icon */}
                <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
          ...
          <Link href="/upload?university=xsyu" className="group">
            <div className="relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border-2 border-transparent hover:border-emerald-400 overflow-hidden transform hover:-translate-y-2">
              ...
              <div className="relative text-center">
                {/* Icon */}
                <div className="w-24 h-24 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-purple-600 via-fuchsia-600 to-pink-600 rounded-3xl p-8 sm:p-12 text-white text-center shadow-2xl">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            ...
            Every photo you share helps advance research and education.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <span className="text-white/80">or scroll up to choose your university</span>
          </div>
        </div>
      </main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              &copy; 2025 Campus Photo Collector. Built for academic research and education.
            </p>
          </div>
        </div>
      </footer>
